<template>
    ...
    <div class="ltn__modal-area ltn__add-to-cart-modal-area">
        <div  class="modal fade" id="liton_wishlist_modal" tabindex="-1">
            <div v-if="$page.props.auth && $page.props.productTo" :key="$page.props.productTo.id" class="modal-dialog modal-md" role="document">
                                        ...
                                        <div class="modal-product-info">
                                            ...
                                            <p class="added-cart">
                                                <span
                                                    ...
                                                    aria-hidden="true"
                                                ></span>
                                                <i v-if="!form.processing" class="fa fa-check-circle"></i> Successfully added to your
                                                Wishlist
                                            </p>
                                            <div class="btn-wrapper">
                                                <a @click="go('wishlist.index')" href="javascript: void(0)" class="theme-btn-1 btn btn-effect-1"
                                                >View Wishlist</a
                                                >
                                            </div>
                                        </div>
                        ...
                        <div class="ltn__quick-view-modal-inner">
                            <div >
                                <div class="account-login-inner">
                                    <div class="go-to-btn mt-20 d-flex align-items-center justify-content-center">
                                        <a @click="isLogin = !isLogin" href="javascript: void(0)"><small>{{isLogin ? "You don't have account" : "You have account"}} ?</small></a>
                                    </div>
                                    <form v-if="isLogin" @submit.prevent="login($page.props.productTo)" action="#" class="ltn__form-box contact-form-box">
                                        <input v-model="loginForm.email" autofocus type="email" id="inputEmail" required
                                        ...
                                        <input v-model="loginForm.password" required type="password" id="inputPassword"
...
<!--                                        </div>-->
                                    ...
                                    <form v-else @submit.prevent="register($page.props.productTo)" class="ltn__form-box contact-form-box">
                                        <input
                                        ...
                                        <label class="checkbox-inline">
                                            ...
                                            I consent to Herboil processing my personal data in order to send personalized
                                        ...
                                        <div class="btn-wrapper">
                                            <button :class="{ 'opacity-25': registerForm.processing }" :disabled="form.processing" class="theme-btn-1 btn reverse-color btn-block" type="submit">
                                                {{ $t("register.sign_up") }}
                                            </button>
                                        </div>
                                    </form>
    ...
    export default  {
        ...
        methods: {
            ...
            register : function(model){
                let app = this;
                this.registerForm.transform((data) => ({
                    ...data,
                    wishlist : true,
