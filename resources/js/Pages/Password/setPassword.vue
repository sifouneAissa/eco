...
export default {
  ...
  data() {
    return {
      form: useForm({
        name: this.$page.props.shopping_user ? this.$page.props.shopping_user.name : "",
        email: this.$page.props.shopping_user ? this.$page.props.shopping_user.email : "",
        password: "",
            ...
            <div class="form-row">
              <div class="form-group col-md-12">
                ...
                <div class="form-label-group">
                  ...
                  />
                  <label for="inputPasswordCofirmation">{{
