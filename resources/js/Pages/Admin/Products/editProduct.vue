            ...
            <div>
                <div class="mb-5 form-label-group">
                    <div class="form-group">
                        ...
                        <edit-t :type="'input'" @write="write" :attr="'Name'" :keyV="'name'" :model="this.model"
                                :cvalues="this.form.langs"/>
                    ...
                    <div class="form-group">
                        <label>Price</label>
                        <input v-model="form.price" type="number" id="inputEmail" class="form-control"
                               placeholder="0000.0">
                    ...
                    <div class="form-group">
                        ...
                        <input v-model="form.old_price" type="number" id="inputEmail" class="form-control"
                               placeholder="0000.0">
                    ...
                    <div class="form-group">
                        ...
                        <edit-t :type="'editor'" @write="write" :attr="'Description'" :keyV="'desc'" :model="this.model"
                                :cvalues="this.form.langs"/>
                    ...
                    <div class="row ">
                        <div class="col-12 form-group">
                            ...
                            <div class=" float-right custom-control custom-radio custom-control-inline">
                                <input v-model="form.start_over" type="checkbox" id="customRadioInline1"
                ...
                <div class="modal-footer d-flex  ">
                    <button type="button" class="btn btn-outline-warning" @click="resetModel" data-dismiss="modal">
                        {{$t("account.addresses.add_card.cancel")}}
                    </button>
                    <button type="button" @click="submit" class="btn btn-warning">
    ...
    export default {
        ...
        data() {
            return {
                ...
                selected: null,
                options1: this.$page.props.categories.map(function (item) {
                    return {name: item.name, id: item.id};
                }),
                options2: this.$page.props.inventories.map(function (item) {
                    return {name: item.quantity, id: item.id};
                })
            }
        ...
        methods: {
            ...
            submit: function () {
                ...
                })).patch(this.route('admin.product.update', {
                    id: this.model.id
                }), {
                    headers: {
