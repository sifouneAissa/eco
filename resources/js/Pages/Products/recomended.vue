                                ...
                                <div id="gallery" class="bg-white rounded shadow-sm p-4 mb-4">
                                    <div class="restaurant-slider-main position-relative homepage-great-deals-carousel">
                                        <div class="owl-carousel owl-theme homepage-ad">
                                            <div v-for="media in $page.props.product.media" :key="media.id" class="item">
                                                <img class="img-fluid" :src="media.url">
                                            </div>

                                        </div>
                                        <div class="position-absolute restaurant-slider-pics bg-dark text-white">1 of {{$page.props.product.media.length}} Photos</div>
<!--                                        <div class="position-absolute restaurant-slider-view-all"><button type="button" class="btn btn-light bg-white">See all Photos</button></div>-->
                            ...
                            <div class="tab-pane fade" id="pills-restaurant-info" role="tabpanel" aria-labelledby="pills-restaurant-info-tab">
                                <div id="restaurant-info" class="bg-white rounded shadow-sm p-4 mb-4">
                                    ...
                                    <p class="mb-3">{{$page.props.product.name}}
                                        <br> {{$page.props.product.desc}}
                                    </p>
                                    ...
                                    <p class="mb-2 text-black"><i class="icofont-label text-primary mr-2"></i>
                                        <span class="badge badge-success"> {{$page.props.product.category.name}}  </span>
                                    </p>
<!--                                    <hr class="clearfix">-->
