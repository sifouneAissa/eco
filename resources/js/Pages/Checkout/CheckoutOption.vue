...
export default {
  ...
  data() {
    return {
      show : (this.$page.props.shopping_session && this.$page.props.shopping_session.cart_items.length),
      form: useForm({
        address_id: null,
...
<!--                          <button class="btn theme-btn-1 btn-effect-1 text-uppercase" type="submit">Place order</button>-->
                      ...
                      <div  v-else class="ltn__checkout-payment-method mt-50">
                          <button class="btn theme-btn-1 btn-effect-1 text-uppercase" @click="go()">Add Products</button>
                      </div>
                  </div>
                  <div  class="col-lg-6">
                      <div v-if="show" class="shoping-cart-total mt-50">
                          ...
                          <table  class="table">
                              <tbody>
                              <tr v-for="item in $page.props.shopping_session.cart_items" :key="item.id">
