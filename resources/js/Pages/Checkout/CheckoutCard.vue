...
export default {
  ...
  methods: {
    incrQP(by) {
      ...
      if (this.model.quantity > this.$page.props.product.isA.remain)
        this.model.quantity = this.$page.props.product.isA.remain;
      ...
      <div class="container">
        <div class="card bg-light rounded">
          <div class="card-header">
            ...
            <p class="col-6 h2">
              {{ $t("listing.checkout_card.total") }} : {{ $page.props.currency_code }}
              {{ $page.props.product.cprice * $page.props.product.quantity }}
            </p>
          </div>
