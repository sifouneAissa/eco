<script>
    ...
    export default {
        ...
        data() {
            return {
                show: this.$page.props.productToCheckout,
                form: useForm({
                    address_id: null,
        ...
        methods: {
            ...
            SelectPaymentMethod(data) {
                // console.log(tapp$t('hello'));
                // const toast = useToast();
                // toast.success(tapp.$t("notifications.success"))
            ...
            <div class="container">
                <div class="row">
                    <div v-if="show" class="col-lg-12">
                        ...
                        <chooseAddress
                            v-if="this.$page.props.productToCheckout"
                            @setSelectedAddress="setSelectedAddress"
                            :models="$page.props.addresses"
                        />
                    </div>
                    <div class="col-12">
                        <div v-if="show" class="ltn__checkout-payment-method mt-50">
                            ...
                            <choosePayment
                                ...
                                :form="form"
                                :disable="this.form.address_id === null"
                                :smodel="this.$page.props.productToCheckout"
                                @SelectPaymentMethod="SelectPaymentMethod"
                            />
                        </div>
